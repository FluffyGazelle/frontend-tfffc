...
const Selection=  () => {
    ...
    useEffect(() => {
        const fetchUsers= async () =>{
          ...
          const response= await fetch('https://backend-tfffc.herokuapp.com/api/user/getstudents')
    ...
    const assignStudent= async (studentEmail) => { 
        ...
        try {
          const response = await fetch('https://backend-tfffc.herokuapp.com/api/user/update', {
            method: 'PATCH',
